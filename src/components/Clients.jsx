    ...
    return (
        ...
        <section className="partners max-w-2xl mx-auto py-5 my-5">
            ...
            <Swiper
                ...
                <SwiperSlide className="bahana"><img src={bahama} alt="bahana" loading="lazy" /></SwiperSlide>
                <SwiperSlide className="habatour"><img src={realtour} alt="realtour" loading="lazy" /></SwiperSlide>
        ...
        <img src={elemenTriangleOrange} alt="" loading="lazy" />
      </div>
        </section>
        </>
    );

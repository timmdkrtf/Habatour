            ...
            <div className="container">
                <div className="content">
                    ...
                    <div className="content-text">
                        ...
                        <p>Habatour adalah persembahan dari PT Abdi Sarana Wisata yang merupakan biro jasa yang menyediakan paket perjalanan religi seperti umroh, haji, ziarah, dan juga kegiatan Islami lainnya. </p>

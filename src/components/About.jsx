            ...
            <div className="container">
                <div className="content">
                    ...
                    <div className="content-text">
                        ...
                        <p>Habatour adalah persembahan dari PT Abdi Solusi Wisata yang merupakan biro jasa yang menyediakan paket perjalanan religi seperti umrah, ziarah, dan juga kegiatan Islami lainnya. </p>
